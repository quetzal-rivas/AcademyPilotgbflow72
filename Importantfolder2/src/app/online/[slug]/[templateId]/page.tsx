...
export default function TemplateSpecificPage() {
  ...
  // Basic validation: must be public, must have this specific template enabled
  if (!data || !data.isPublic || !data.enabledTemplates?.includes(templateId)) {
    notFound();
  }
